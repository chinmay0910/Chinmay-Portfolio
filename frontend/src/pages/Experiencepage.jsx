          ...
          description={
            <>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-2">
                <li><strong>ShieldAI (AI Red vs. Blue Platform)</strong> — Lead developer for an automated threat emulation platform, utilizing Python and AI agents to scan subdomains, map vulnerability surfaces, and correlate SIEM alerts (Wazuh/Suricata) via LLMs.</li>
